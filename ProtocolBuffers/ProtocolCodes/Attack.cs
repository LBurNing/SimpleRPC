...
public static partial class AttackReflection {
  ...
  static AttackReflection() {
    byte[] descriptorData = global::System.Convert.FromBase64String(
        string.Concat(
          "CgxhdHRhY2sucHJvdG8iOAoGQXR0YWNrEhAKB3Byb3RvSWQYzQggASgFEgoK",
          "AmlkGAEgASgFEhAKCHRhcmdldElkGAIgASgFYgZwcm90bzM="));
    descriptor = pbr::FileDescriptor.FromGeneratedCode(descriptorData,
        new pbr::FileDescriptor[] { },
        new pbr::GeneratedClrTypeInfo(null, null, new pbr::GeneratedClrTypeInfo[] {
          new pbr::GeneratedClrTypeInfo(typeof(global::Attack), global::Attack.Parser, new[]{ "ProtoId", "Id", "TargetId" }, null, null, null, null)
        }));
  }
  #endregion
...
#endif
{
  ...
  public static pbr::MessageDescriptor Descriptor {
    get { return global::AttackReflection.Descriptor.MessageTypes[0]; }
  }
  ...
  public const int ProtoIdFieldNumber = 1101;
  ...
  public int CalculateSize() {
    int size = 0;
    if (ProtoId != 0) {
      size += 2 + pb::CodedOutputStream.ComputeInt32Size(ProtoId);
    }
    if (Id != 0) {
